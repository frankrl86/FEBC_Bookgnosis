    ...
    return (
        <div className="our-mission">
            <div className="mission-section">
                ...
                <p>BookGnosis is a virtual collection of free copyright books and articles that can be read online for free! Whether you're an avid reader, a student, or simply someone who loves to explore new ideas, BookGnosis is a place to widen your knowledge with the click of a button.</p>
            </div>
            <div className="mission-section">
